...
def get_scatter_chart(entered_site, payload2):
    filtered_df2 = spacex_df[spacex_df['Payload Mass (kg)'].between(payload2[0],payload2[1])]
    if entered_site == 'ALL':
        ...
        filtered_df3 = filtered_df2[filtered_df2['Launch Site'] == str(entered_site)]
